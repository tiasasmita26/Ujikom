                            ...
                            <div class="contact-information">
                            	<div class="row">
                            		<div class="col-md-6 col-sm-6">
                            			<p>Kp. Ciborerang Rt.01 Rw. 20 Desa. Sangkanhurip Kecamatan Katapang Kab. Bandung</p>
                            		</div> <!-- /.col-md-6 -->
                            		<div class="col-md-6 col-sm-6 text-right">
                            			<ul>
                            				<li>Telp: 0815-6490-9996</li>
                            				<li>Email: AbielWeddingG@gmail.com</li>
											<li>IG: abil.wedding</li>
                            			</ul>
                            		</div> <!-- /.col-md-6 -->
                            	</div> <!-- /.row -->
